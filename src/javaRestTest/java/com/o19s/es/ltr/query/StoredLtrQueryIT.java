...
public class StoredLtrQueryIT extends BaseIntegrationTest {
  ...
  public void testScriptFeatureUseCaseMissingFeatureNaiveAdditiveDecisionTree() throws Exception {
    ...
    QueryBuilder query =
        QueryBuilders.boolQuery().must(new WrapperQueryBuilder(sbuilder.toString()));
        ...
        new SearchSourceBuilder()
            ...
            .ext(
                Collections.singletonList(
                    new LoggingSearchExtBuilder().addQueryLogging("log", "test", false)));

    assertResponse(
        client().prepareSearch("test_index").setSource(sourceBuilder),
        resp -> {

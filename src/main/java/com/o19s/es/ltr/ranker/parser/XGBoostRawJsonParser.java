...
public class XGBoostRawJsonParser implements LtrRankerParser {
  ...
  public NaiveAdditiveDecisionTree parse(FeatureSet set, String model) {
    ...
    NaiveAdditiveDecisionTree.Node[] adjustedTrees =
        new NaiveAdditiveDecisionTree.Node[trees.length];
  ...
  private NaiveAdditiveDecisionTree.Node reorderTreeFeatures(
      NaiveAdditiveDecisionTree.Node node, Map<Integer, Integer> modelFeaturesReordering) {
  ...
  private static class XGBoostDefinition {
    ...
    static {
      PARSER =
          new ObjectParser<>(
              "xgboost_definition", true, XGBoostRawJsonParser.XGBoostDefinition::new);
      ...
      PARSER.declareIntArray(
          XGBoostRawJsonParser.XGBoostDefinition::setVersion, new ParseField("version"));
    }

    public static XGBoostRawJsonParser.XGBoostDefinition parse(
        XContentParser parser, FeatureSet set) throws IOException {
      ...
      if (startToken == XContentParser.Token.START_OBJECT) {
        ...
        if (definition.learner == null) {
          throw new ParsingException(
              parser.getTokenLocation(), "XGBoost model missing required field [learner]");
        }
        ...
        Optional<String> firstUnsupportedType =
            definition.learner.featureTypes.stream()
        ...
        throw new ParsingException(
            parser.getTokenLocation(), "Expected [START_OBJECT] but got [" + startToken + "]");
      }
  ...
  static class XGBoostLearner {
    ...
    static {
      PARSER =
          new ObjectParser<>("xgboost_learner", true, XGBoostRawJsonParser.XGBoostLearner::new);
      PARSER.declareObject(
      ...
      PARSER.declareStringArray(
          XGBoostRawJsonParser.XGBoostLearner::setFeatureNames, new ParseField("feature_names"));
      PARSER.declareStringArray(
          XGBoostRawJsonParser.XGBoostLearner::setFeatureTypes, new ParseField("feature_types"));
    }
    ...
    public static XGBoostRawJsonParser.XGBoostLearner parse(XContentParser parser, FeatureSet set)
        throws IOException {
  ...
  static class XGBoostGradientBooster {
    ...
    private static final ObjectParser<XGBoostRawJsonParser.XGBoostGradientBooster, FeatureSet>
        PARSER;

    static {
      PARSER =
          new ObjectParser<>(
              "xgboost_gradient_booster", true, XGBoostRawJsonParser.XGBoostGradientBooster::new);
      PARSER.declareObject(
    ...
    static XGBoostRawJsonParser.XGBoostGradientBooster parse(XContentParser parser, FeatureSet set)
        throws IOException {
      return PARSER.apply(parser, set);
    }
  ...
  static class XGBoostModel {
    ...
    static {
      ...
      PARSER.declareIntArray(
          XGBoostRawJsonParser.XGBoostModel::setTreeInfo, new ParseField("tree_info"));
    }
    ...
    public static XGBoostRawJsonParser.XGBoostModel parse(XContentParser parser, FeatureSet set)
        throws IOException {
      try {
        return PARSER.apply(parser, set);
    ...
    public void setTrees(List<XGBoostTree> parsedTrees) {
      NaiveAdditiveDecisionTree.Node[] trees =
          new NaiveAdditiveDecisionTree.Node[parsedTrees.size()];
  ...
  static class XGBoostObjective {
    ...
    static {
      PARSER =
          new ObjectParser<>("xgboost_objective", true, XGBoostRawJsonParser.XGBoostObjective::new);
      PARSER.declareString(XGBoostRawJsonParser.XGBoostObjective::setName, new ParseField("name"));
    }

    public static XGBoostRawJsonParser.XGBoostObjective parse(XContentParser parser, FeatureSet set)
        throws IOException {
      return PARSER.apply(parser, set);
    }
      ...
      switch (name) {
        ...
        default ->
            throw new IllegalArgumentException(
                "Objective [" + name + "] is not a valid XGBoost objective");
      }
    }
  ...
  static class XGBoostTree {
    ...
    static {
      ...
      PARSER.declareIntArray(
          XGBoostRawJsonParser.XGBoostTree::setLeftChildren, new ParseField("left_children"));
      PARSER.declareIntArray(
          XGBoostRawJsonParser.XGBoostTree::setRightChildren, new ParseField("right_children"));
      PARSER.declareIntArray(
          XGBoostRawJsonParser.XGBoostTree::setParents, new ParseField("parents"));
      PARSER.declareFloatArray(
          XGBoostRawJsonParser.XGBoostTree::setSplitConditions, new ParseField("split_conditions"));
      PARSER.declareIntArray(
          XGBoostRawJsonParser.XGBoostTree::setSplitIndices, new ParseField("split_indices"));
      PARSER.declareIntArray(
          XGBoostRawJsonParser.XGBoostTree::setDefaultLeft, new ParseField("default_left"));
      PARSER.declareIntArray(
          XGBoostRawJsonParser.XGBoostTree::setSplitTypes, new ParseField("split_type"));
      PARSER.declareFloatArray(
          XGBoostRawJsonParser.XGBoostTree::setBaseWeights, new ParseField("base_weights"));
    }

    public static XGBoostRawJsonParser.XGBoostTree parse(XContentParser parser, FeatureSet set)
        throws IOException {
